...
def get_filters():
    ...
    while True:
        city = input('Which country - Chicago/CH, New York City/NYC, or Washington/WA? ').lower()
        print()
    ...
    while True:
        if choice:
            filter=input('You can filter by month , day or both ').lower()
            print()
            if filter=='month':
                print('Which months data to look for?')
...
def station_stats(df):
    ...
    print('\n Below The Most Popular Stations and Trip...\n')
    start_time = time.time()

    # TO DO: display most commonly used start station
    print()
    print('Most commonly used start station as per data was {}'.format(df['Start Station'].mode()[0]))

    # TO DO: display most commonly used end station
    print()
    print('Most commonly used end station as per data was {}'.format(df['End Station'].mode()[0]))
...
def trip_duration_stats(df):
    ...
    print('Passengers had journey for {} days, {} hours, {} minutes and {} seconds'.format(sum_days, sum_hours, sum_minutes, sum_seconds))
    ...
    print('average time is {} hours, {} minutes and {} seconds'.format(mean_hours, mean_minutes, mean_seconds))
